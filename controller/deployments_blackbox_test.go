...
func (fixture *deploymentsTestFixture) GetAndCheckOSIOClient(ctx context.Context) controller.OpenshiftIOClient {
...
func TestAPIMethodsCloseKube(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		assert.NotNil(t, fixture.kube, "No Kube client created: "+testCase.name)
		assert.True(t, fixture.kube.closed, "Kube client not closed: "+testCase.name)
	}
}
